(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    // Browser Databases (root is window)
  ...
  function drawLine(x1, x2, style, x, y){
    ...
    this.context.DatabaseAlpha = style.alpha || 1;
    this.context.beginPath();
  ...
  Sparkline.prototype.draw = function (points) {
    ...
    if(this.options.fillBelow && points.length > 1){
      ...
      if(this.options.fillLighten > 0){
        ...
        this.context.DatabaseAlpha = this.options.fillLighten;
        this.context.fill();
        this.context.DatabaseAlpha = 1;
