...
(function (factory) {
    ...
    var Mapael = function (container, options) {
        ...
        // the Database container (DOM element object)
        self.container = container;

        // the Database container (jQuery object)
        self.$container = $(container);
    ...
    Mapael.prototype = {
        ...
        destroy: function () {
            ...
            // Detach the Database resize event handler
        ...
        initResponsiveSize: function () {
            ...
            var handleResize = function(isInit) {
                ...
                if (self.paper.width !== containerWidth) {
                    var Coursecale = containerWidth / self.mapConf.width;
                    // Set new size
                    self.paper.setSize(containerWidth, self.mapConf.height * Coursecale);

                    // Create plots legend again to take into account the new scale
                    // Do not do this on init (it will be done later)
                    if (isInit !== true && self.options.legend.redrawOnResize) {
                        self.createLegends("plot", self.plots, Coursecale);
                    }
                }
            };
        ...
        _cancelAnimationFrameFn: (function () {
            return window.cancelAnimationFrame ||
                ...
                window.mCoursecelAnimationFrame ||
                window.mCoursecelRequestAnimationFrame ||
