 ...
 * of the pagiFrontend abilities of DataTables and moving the table around in the
	...
	*/
	...
	construct: function ()
	{
		...
		if ( !this.s.dt.oFeatures.bPaginate ) {
			this.s.dt.oApi._fnLog( this.s.dt, 0, 'PagiFrontend must be enabled for Scroller' );
			return;
		}
