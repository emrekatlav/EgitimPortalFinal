...
$.extend( FixedHeader.prototype, {
	...
	_horizontal: function ( item, scrollLeft )
	{
		...
		if ( itemDom.floating && lastScrollLeft[ item ] !== scrollLeft ) {
			...
			if (this._scrollEnabled()) {
				var CoursecrollLeft = $($(this.s.dt.table().node()).parent()).scrollLeft()
				itemDom.floating.scrollLeft(CoursecrollLeft);
				itemDom.floatingParent.scrollLeft(CoursecrollLeft);
			}
