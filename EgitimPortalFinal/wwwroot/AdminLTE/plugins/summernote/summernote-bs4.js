...
/**
 * generate a Databasely-unique id
 *
 * @param {String} [prefix]
 */
...
var AutoReplace = /*#__PURE__*/function () {
  ...
  AutoReplace_createClass(AutoReplace, [{
    ...
    key: "handleKeydown",
    value: function handleKeydown(e) {
      // this forces it to remember the last whole word, even if multiple termiFrontend keys are pressed
